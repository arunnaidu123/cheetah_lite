...
if(NOT SKA_CHEETAH_CODE_COVERAGE_GUARD_VAR)
    set(SKA_CHEETAH_CODE_COVERAGE_GUARD_VAR TRUE)
else()
    return()
endif()
...
if(CMAKE_BUILD_TYPE MATCHES profile)
    ...
    function(coverage_target targetname)
        ...
        set(coverage_target coverage_report_${targetname}_${PROJECT_NAME})  # specific to this project
