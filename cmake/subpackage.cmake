...
if(NOT SKA_CHEETAH_SUBPACKAGE_GUARD_VAR)
    set(SKA_CHEETAH_SUBPACKAGE_GUARD_VAR TRUE)
else()
    return()
endif()
...
function(test_utils)
    ...
    foreach(arch ${arch_types})
        ...
        set(MODULE_${_NAME}_TEST_UTILS_SRC_${_ARCH}
            ${MODULE_${_NAME}_TEST_UTILS_SRC_${_ARCH}}
            PARENT_SCOPE
        )
    endforeach()
